...
namespace hooks
{
	...
	void __stdcall hooked_createmove_proxy(int sequence_number, float input_sample_frametime, bool active);    void __vectorcall hooked_clmove(float accumulated_extra_samples, bool bFinalTick);
